...
import MangaTagSection from "../Mangas/MangaTagSection.jsx";
...
const Manga = () => {
  ...
  const { allChapters, error: ChapterListError } = useChapterList(id);
  ...
  if (error || !mangaData)
    return <div>Error: {error || "Manga not found"}</div>;

  return (
    <>
      {showReadModal && (
        <ReadModal
          readModalRef={readModalRef}
          ...
          <div className="relative z-10 px-6 mt-[68px] mb-8">
            <div
              className={`mx-auto grid grid-flow-row-dense
                          ...
                          ${
                            sidebar ? "" : "2xl:grid-cols-[40px_200px_1fr_40px]"
                          }
                          items-start gap-4`}
            >
              ...
              >
                <p
                  className="mb-1
                            ...
                            max-[610px]:text-base text-xl sm:text-2xl md:text-3xl xl:text-[40px]"
                >
                  {mangaData.Title}
                </p>
                <div
                  className="line-clamp-2 font-normal inline-block
                              leading-5 sm:leading-6
                              text-base sm:text-2xl xl:text-xl"
                >
                  {mangaData.AltTitles}
                </div>
                <div className="grow hidden sm:block"></div>
                <div className="flex flex-row gap-2">
                  <div className="font-normal text-xs sm:text-lg truncate">
                    {mangaData.Author}
                  </div>
                </div>
              </div>
              <div className="col-start-3 col-span-full sm:col-span-1 sm:col-start-3 sm:row-start-3">
                {Array.isArray(mangaData.tags) ? (
                ...
                <div className="inline-flex items-center gap-1 font-bold text-[13px] uppercase">
                  ...
                  />
                  <span>
                    Publication: {mangaData.PublicationYear}, {mangaData.Status}
                  </span>
                </div>
              </div>
              <div className="col-start-3 hidden sm:block"></div>
              <div className="col-start-3 min-h-[100px] rounded-lg bg-teal-500 shadow">
                Statistic
              </div>
              <div
              ...
              >
                ...
                >
                  ...
                  <span className="text-base font-semibold">Add to MDList</span>
                </button>
                ...
                >
                  ...
                  <span className="text-base font-semibold">Start Reading</span>
                </button>
              ...
              <div className="col-start-2 col-span-full">
                ...
                <div className="sm:hidden flex flex-col">
                  ...
                  {/* tags */}
                  {showMore && <MangaTagSection data={mangaData} />}
              ...
              <div className="col-start-2 col-span-full">
                ...
                <div className="flex gap-6 items-start">
                  ...
                  <div className="grow">
                    {tab === "chapters" && (
                      <MangaChapterSection allChapters={allChapters} />
                    )}
                    {tab === "art" && <ArtGallery />}
                  </div>
                </div>
