...
const SelfPublish = () => {
  ...
  const { mangaIDs, mangaTitles, coverUrls, mangaAuthors, mangaDescriptions } =
    mangaData || {};
  if (error) {
  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-4">
        <h2 className="my-4 z-2 min-[1448px]:text-4xl font-semibold sm:text-2xl text-xl font-spartan">
          Self-Published
        </h2>
